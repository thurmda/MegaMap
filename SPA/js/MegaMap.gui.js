MM.gui = (function(){
	...
	var _googleUnavailable = function () {	
		...
		if(window.location.href.indexOf("glgdev.com") < 0 ){
			message +="<h3>You need to view this site on a url that contains <i>glgdev.com</i> "+
					"(the API key is registered to *.glgdev.com) </h3>"
		}
		message +="</ul>";
	...
	var _showMap = function(){
		_$load.animate({opacity: 0}, 800 , function(){
